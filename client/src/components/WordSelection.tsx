...
const WordSelection: React.FC<WordSelectionProps> = ({ words, onSelect }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="sketch-modal max-w-2xl w-full mx-4 bg-paper">
                {/* Header */}
                <div className="text-center mb-8">
                    <h2 className="text-4xl font-marker text-ink mb-2">
                        Choose Your Word!
                    </h2>
                    <div className="flex items-center justify-center gap-2 font-hand">
                        ...
                        <div className="w-48 h-4 border-2 border-ink rounded-full overflow-hidden p-0.5 bg-white">
                            <div
                ...
                <div className="grid grid-cols-1 gap-4">
                    {words.map((word, index) => (
                        <button
                            ...
                            className="group relative overflow-visible p-6 transition-all duration-300 border-2 border-ink hover:scale-105"
                            style={{
                        ...
                        >
                            <div className="relative z-10 flex items-center justify-between">
                                <span className="text-3xl font-black text-ink font-marker">
                                    {word.toUpperCase()}
                                </span>
                                <div className="w-12 h-12 rounded-full border-2 border-ink bg-white flex items-center justify-center
